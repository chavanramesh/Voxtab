...
public class SelectedFilesAdapter extends BaseAdapter {
    ...
    private LinkedList<MyRecording> Items;

    ViewHolder holder = new ViewHolder();

    public SelectedFilesAdapter(Context context, LinkedList<MyRecording> rowItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            holder.selcted_file.setText(Items.get(position).getRecName());
            holder.file_duration.setText(Items.get(position).getRecDuration());
