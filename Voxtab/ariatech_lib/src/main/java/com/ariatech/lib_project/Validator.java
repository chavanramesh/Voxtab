...
public class Validator {
	...
	/**
	 * Author - Abhijeet Rajput It checks for text contains AlfaNumeric values
	 * 
	 * @param text
	 * @return
	 */
	...
	/**
	 * Author - Abhijeet Rajput This method checks for if text contains more
	 * than 35 char or not
	 * 
	 * @param text
	...
	/**
	 * Author - Abhijeet Rajput It checks for text contains special character.
	...
	/**
	 * Author - Abhijeet Rajput It checks for text contains only numbers
	 * 
	 * @param mobileNumber
	 * @return
	 */
	...
	/**
	 * Auther - Abhijeet Rajput Method will check if spinner is select any item
	 * or not.
	 * 
	 * @param spinner
	 *            - spinner is select any item or not.
	 * @param defaultIndex
	 *            - if defaultIndex is not 0, then spinner sets to default
	 *            position
	 * 
