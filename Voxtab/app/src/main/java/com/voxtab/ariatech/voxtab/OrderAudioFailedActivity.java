 ...
 */
public class OrderAudioFailedActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
//    OrderDetails orderDetails = new Order_Details_Bean();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_audio_failed);

        GlobalData.activities.add(OrderAudioFailedActivity.this);
        context = this;
...
try {
    ...
    GlobalData.printError(e);
        ...
        textViewTitle=(TextView)findViewById(R.id.orderdetailsTitle);
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if(GlobalData.isNetworkAvailable(context)){
                        ...
                        GlobalData.selectedMyRecording =orderDetails.getRecList();
                        ...
                        GlobalData.showSnackBar(btn_conf_Order,getString(R.string.no_connection),true);
                    }
        ...
        textViewTitle.setText(getString(R.string.audio_upload_fail));

        btn_conf_Order.setText(getString(R.string.retry_audio_upload));
...
//            setOrderDetails(orderDetails);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_notifications) {
            ...
            if (isLoggedIn) {
                Intent intent = new Intent(OrderAudioFailedActivity.this, NotificationsActivity.class);
                startActivity(intent);
            } else {
                Intent intent = new Intent(OrderAudioFailedActivity.this, LoginActivity.class);
                intent.putExtra("Name", "com.voxtab.ariatech.voxtab.NotificationsActivity");
                startActivity(intent);
            }
        } else if (id == R.id.nav_recordings) {
            Intent intent = new Intent(OrderAudioFailedActivity.this, MyRecordingsActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_order_history) {
            if (isLoggedIn) {
                Intent intent = new Intent(OrderAudioFailedActivity.this, OrderHistoryActivity.class);
                startActivity(intent);
            } else {
//               Toast.makeText(context, "Please login now", Toast.LENGTH_SHORT).show();
            ...
            if (isLoggedIn) {
                Intent intent = new Intent(OrderAudioFailedActivity.this, SettingsActivity.class);
                startActivity(intent);
            } else {
                Intent intent = new Intent(OrderAudioFailedActivity.this, LoginActivity.class);
            ...
            Intent intent = new Intent(OrderAudioFailedActivity.this, HomeActivity.class);
            startActivity(intent);
...
//            Intent intent = new Intent(OrderAudioFailedActivity.this, ConfidentialityActivity.class);
//            startActivity(intent);
//
//
//        } else if (id == R.id.nav_terms_condition) {
//
//            Intent intent = new Intent(OrderAudioFailedActivity.this, TermsActivity.class);
//            startActivity(intent);
//
//        }
            ...
            Intent intent = new Intent(OrderAudioFailedActivity.this, AboutusActivity.class);
            startActivity(intent);
...
//        }
            ...
            if (isLoggedIn) {
                Intent intent = new Intent(OrderAudioFailedActivity.this, FeedbackActivity.class);
                startActivity(intent);
...
//                    startActivity(new Intent(context,OrderDetails.class));
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            super.onBackPressed();
            Intent in = new Intent(OrderAudioFailedActivity.this,
    ...
    public void setTAT(){
        ...
        try {
           ...
           TAT_Calculation tat_calculation=  TATCalculationGLobal.getTotalFeesAndDuration(context, totalDUration, orderDetails.getDelivery_opt_id(), orderDetails.getService_type_id(), orderDetails.getVas_id(), orderDetails.getTime_slab_id());
            ...
            txt_total_fee.setText("" + Math.round(tat_calculation.totalFee));
