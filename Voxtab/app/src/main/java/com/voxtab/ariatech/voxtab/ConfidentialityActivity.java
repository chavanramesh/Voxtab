 ...
 */
public class ConfidentialityActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        GlobalData.activities.add(ConfidentialityActivity.this);
...
//        });
    ...
    public void init() {
        ...
        webView = (WebView) findViewById(R.id.wv_confidentiality);
        webView.getSettings().setJavaScriptEnabled(true);
        //  webView.loadUrl("http://www.voxtab.com/confidentiality.htm");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_notifications) {
            if (isLoggedIn) {
                Intent intent = new Intent(ConfidentialityActivity.this, NotificationsActivity.class);
                startActivity(intent);
            } else {
                Intent intent = new Intent(ConfidentialityActivity.this, LoginActivity.class);
                intent.putExtra("Name", "com.voxtab.ariatech.voxtab.NotificationsActivity");
                startActivity(intent);
            }
        } else if (id == R.id.nav_recordings) {
            Intent intent = new Intent(ConfidentialityActivity.this, MyRecordingsActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_order_history) {

            if (isLoggedIn) {
                Intent intent = new Intent(ConfidentialityActivity.this, OrderHistoryActivity.class);
                startActivity(intent);
            } else {
//                Toast.makeText(context, R.string.login_alert, Toast.LENGTH_SHORT).show();
            ...
            if (isLoggedIn) {
                Intent intent = new Intent(ConfidentialityActivity.this, SettingsActivity.class);
                startActivity(intent);
            } else {
                Intent intent = new Intent(ConfidentialityActivity.this, LoginActivity.class);
            ...
            Intent intent = new Intent(ConfidentialityActivity.this, HomeActivity.class);
            startActivity(intent);
...
//
//            Intent intent = new Intent(ConfidentialityActivity.this, TermsActivity.class);
//            startActivity(intent);
//
//
//        }
            ...
            Intent intent = new Intent(ConfidentialityActivity.this, AboutusActivity.class);
            startActivity(intent);
...
//        }
            ...
            if (isLoggedIn) {
                Intent intent = new Intent(ConfidentialityActivity.this, FeedbackActivity.class);
                startActivity(intent);
            } else {
//                Toast.makeText(context, R.string.login_alert, Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(ConfidentialityActivity.this, LoginActivity.class);
