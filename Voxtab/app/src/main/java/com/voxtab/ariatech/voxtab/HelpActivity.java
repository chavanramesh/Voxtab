...
public class HelpActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        GlobalData.activities.add(HelpActivity.this);
...
//        webView.loadUrl("http://www.voxtab.com/tandc.htm");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_notifications) {
            ...
            Intent intent = new Intent(HelpActivity.this, NotificationSettingsActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_recordings) {
            Intent intent = new Intent(HelpActivity.this, MyRecordingsActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_order_history) {

            if (isLoggedIn) {
                Intent intent = new Intent(HelpActivity.this, OrderHistoryActivity.class);
                startActivity(intent);
            } else {
...
//            Intent intent = new Intent(HelpActivity.this, ConfidentialityActivity.class);
//            startActivity(intent);
//
//
