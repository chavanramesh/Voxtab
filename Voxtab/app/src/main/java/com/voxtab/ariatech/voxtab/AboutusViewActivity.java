 ...
 */
public class AboutusViewActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        GlobalData.activities.add(AboutusViewActivity.this);
...
//        });
    ...
    public void init() {
        ...
        webView.loadUrl(GlobalData.ABOUT_US_URL);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_notifications) {
            ...
            if (isLoggedIn) {
                Intent intent = new Intent(AboutusViewActivity.this, NotificationsActivity.class);
                startActivity(intent);
            } else {
                Intent intent = new Intent(AboutusViewActivity.this, LoginActivity.class);
                intent.putExtra("Name", "com.voxtab.ariatech.voxtab.NotificationsActivity");
                startActivity(intent);
            }
        } else if (id == R.id.nav_recordings) {
            Intent intent = new Intent(AboutusViewActivity.this, MyRecordingsActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_order_history) {

            if (isLoggedIn) {
                Intent intent = new Intent(AboutusViewActivity.this, OrderHistoryActivity.class);
                startActivity(intent);
            } else {
//                Toast.makeText(context, "Please login now", Toast.LENGTH_SHORT).show();
            ...
            if (isLoggedIn) {
                Intent intent = new Intent(AboutusViewActivity.this, SettingsActivity.class);
                startActivity(intent);
            } else {
                Intent intent = new Intent(AboutusViewActivity.this, LoginActivity.class);
            ...
            Intent intent = new Intent(AboutusViewActivity.this, HomeActivity.class);
            startActivity(intent);
...
//            Intent intent = new Intent(AboutusViewActivity.this, ConfidentialityActivity.class);
//            startActivity(intent);
//
//
//        } else if (id == R.id.nav_terms_condition) {
//
//            Intent intent = new Intent(AboutusViewActivity.this, AboutusViewActivity.class);
//            startActivity(intent);
//
//        }
        else if (id == R.id.nav_about_us) {

            Intent intent = new Intent(AboutusViewActivity.this, AboutusActivity.class);
            startActivity(intent);
...
//        }
            ...
            if (isLoggedIn) {
                Intent intent = new Intent(AboutusViewActivity.this, FeedbackActivity.class);
                startActivity(intent);
