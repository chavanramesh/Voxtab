 ...
 */
public class DataUsageSettingsActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {


    private Context context;
    private Toolbar toolbar;

    //RadioGroup rg_data_usage;
    RadioButton rb_wifi, rb_network, rb_anytym, rb_ask;
    Button btn_back;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        GlobalData.activities.add(DataUsageSettingsActivity.this);
...
//        });
    ...
    public void init() {
        //rg_data_usage= (RadioGroup) findViewById(R.id.rg_data_usage);
        rb_wifi = (RadioButton) findViewById(R.id.rb_wifi);
        rb_network = (RadioButton) findViewById(R.id.rb_network);
        rb_anytym = (RadioButton) findViewById(R.id.rb_anytime);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DataUsageSettingsActivity.this, SettingsActivity.class);
                startActivity(intent);
            }
        });
        ...
        rb_wifi.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {


                    GlobalData.setUploadkey(context, 1);

                    rb_network.setChecked(false);
                    rb_anytym.setChecked(false);
        ...
        rb_network.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    GlobalData.setUploadkey(context, 2);
                    rb_wifi.setChecked(false);
                    rb_anytym.setChecked(false);
                    rb_ask.setChecked(false);
        ...
        rb_anytym.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    GlobalData.setUploadkey(context, 3);
                    rb_network.setChecked(false);
                    rb_wifi.setChecked(false);
                    rb_ask.setChecked(false);
        ...
        rb_ask.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {

                    GlobalData.setUploadkey(context, 4);
        ...
        int val = GlobalData.getUploadkey(context);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_notifications) {
            ...
            if (isLoggedIn) {
                Intent intent = new Intent(DataUsageSettingsActivity.this, NotificationsActivity.class);
                startActivity(intent);

            } else {
                Intent intent = new Intent(DataUsageSettingsActivity.this, LoginActivity.class);
                intent.putExtra("Name", "com.voxtab.ariatech.voxtab.NotificationsActivity");
                startActivity(intent);
            }

        } else if (id == R.id.nav_recordings) {
            Intent intent = new Intent(DataUsageSettingsActivity.this, MyRecordingsActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_order_history) {
            if (isLoggedIn) {
                Intent intent = new Intent(DataUsageSettingsActivity.this, OrderHistoryActivity.class);
                startActivity(intent);
            } else {
//                Toast.makeText(context, R.string.login_alert, Toast.LENGTH_SHORT).show();
            ...
            Intent intent = new Intent(DataUsageSettingsActivity.this, HomeActivity.class);
            startActivity(intent);
...
//
//            Intent intent = new Intent(DataUsageSettingsActivity.this, ConfidentialityActivity.class);
//            startActivity(intent);
//
//        } else if (id == R.id.nav_terms_condition) {
//
//            Intent intent = new Intent(DataUsageSettingsActivity.this, TermsActivity.class);
//            startActivity(intent);
//
//        }
        else if (id == R.id.nav_about_us) {

            Intent intent = new Intent(DataUsageSettingsActivity.this, AboutusActivity.class);
            startActivity(intent);
...
//        }
            ...
            if (isLoggedIn) {
                Intent intent = new Intent(DataUsageSettingsActivity.this, FeedbackActivity.class);
                startActivity(intent);
            } else {
                Intent intent = new Intent(DataUsageSettingsActivity.this, LoginActivity.class);
